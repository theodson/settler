...
if "$SKIP_PHP"; then
  ...
  apt-get install -y --allow-change-held-packages \
    ...
    php8.5-enchant php8.5-fpm php8.5-gd php8.5-gmp php8.5-imap php8.5-interbase php8.5-intl php8.5-ldap \
    php8.5-mbstring php8.5-mysql php8.5-odbc php8.5-pgsql php8.5-phpdbg php8.5-pspell php8.5-readline \
    php8.5-snmp php8.5-soap php8.5-sqlite3 php8.5-sybase php8.5-tidy php8.5-xml php8.5-xsl \
    php8.5-zip php8.5-imagick php8.5-memcached php8.5-redis php8.5-xmlrpc php8.5-xdebug
