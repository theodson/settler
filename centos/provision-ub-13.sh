#!/usr/bin/env bash
#
# comparison of provisioninig for ubuntu using the cetnos scripts - homestead 13 (php-8.0 php-8.1 introduced).
# an attempt to align out bg' custom VM to Ubunuto (via laravel settler/homestead built scripts).
#
